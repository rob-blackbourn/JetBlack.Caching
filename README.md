...
Click here for the source for [`CircularBuffer<T>`](https://github.com/rob-blackbourn/JetBlack.Caching/blob/master/JetBlack.Caching/Collections/Generic/CircularBuffer.cs).

### Tests

Here are some simple tests which also demonstrate how to use the class.

Click here for the source for [`CircularBufferFixture`](https://github.com/rob-blackbourn/JetBlack.Caching/blob/master/JetBlack.Caching.Test/Collections/Generic/CircularBufferFixture.cs).
